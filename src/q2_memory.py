...
La estrategia que se utilizo fue cargar los datos desde el json sin procesamiento adicional, luego se filtra solo el campo content y se le asigna un tipo de dato sting para reducir consumo de memoria
...
Esta estrategia es la misma utilizada en el punto 3, se puede idependizar la funcion calculate_tf para ser utiizada en los dos puntos.
